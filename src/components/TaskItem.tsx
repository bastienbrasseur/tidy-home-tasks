...
export const TaskItem = ({ task, onToggle, onDelete, onToggleUrgent }: TaskItemProps) => {
  const buttonClasses = "p-1.5 rounded-full transition-all duration-200 hover:scale-110";
  ...
  return (
    <div className={cn(
      ...
      <button
        ...
        className={cn(
          buttonClasses,
          "text-gray-400 hover:text-ios-red opacity-0 group-hover:opacity-100"
        )}
      >
